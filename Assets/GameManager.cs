...
public class GameManager : MonoBehaviour
{
    ...
    static StoryBlock block7 = new StoryBlock("You've approached the wooden doors, inserted the key, timed and.. it open1 you are free!", "", "");
    static StoryBlock block6 = new StoryBlock("The floor is covered with huge amounts of the small stones. You started to move your hand around them to maybe find something useful.. and there is something!! Its a key", "Try to unlock doors", "Do nothing", block7, block8);
    static StoryBlock block5 = new StoryBlock("You started reaching into your pockets, but nothing could be found there", "Inspect floor", "Check the doors", block6, block3);
    ...
    static StoryBlock block2 = new StoryBlock("You started to panic and screamed for help, but it looks like you're here completely alone", "Sit down", "Check the doors", block4, block3);
